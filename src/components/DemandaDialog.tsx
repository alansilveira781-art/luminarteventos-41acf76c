  ...
  const save = useMutation({
    mutationFn: async () => {
      ...
      if (
        ...
        throw new Error(
          "A soma das formas de pagamento precisa ser igual ao valor total da aquisiÃ§Ã£o.",
        );
      }
        ...
        <Tabs defaultValue="dados" className="w-full">
          ...
          <TabsContent value="dados" className="space-y-4 pt-4">
            <FormSection>
              ...
              <FormField label="Tipo de AquisiÃ§Ã£o">
                <div className="flex items-center gap-2">
                  ...
                  {tiposDespesa.podeCriar && (
                    <Button
                      ...
                      title="Cadastrar novo tipo de aquisiÃ§Ã£o"
                    >
              ...
              <FormField label="Tem Nota Fiscal (NF)?">
                <label className="flex items-center gap-2 h-10 text-sm">
                  <input
                    ...
                    className="h-4 w-4"
                  />
                  <span className="text-muted-foreground">Marque se esta aquisiÃ§Ã£o terá NF</span>
                </label>
              </FormField>
              {form.tem_nf !== false && (
            ...
            {tipoRequerItens ? (
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  <label className="text-xs font-medium text-muted-foreground">Itens da aquisiÃ§Ã£o</label>
