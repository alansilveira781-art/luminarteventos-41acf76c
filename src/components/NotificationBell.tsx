...
import { NotificacoesDialog } from "@/components/NotificacoesDialog";
...
export function NotificationBell() {
  ...
  const pendentes = data.filter((n) => !n.concluida).length;
  ...
  return (
    <>
      ...
      <NotificacoesDialog open={dialogOpen} onOpenChange={setDialogOpen} />
    </>
  );
}
