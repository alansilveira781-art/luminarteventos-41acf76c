...
const allItems: NavItem[] = [
  ...
  { title: "Relatórios", url: "/comercial/relatorios", icon: FileBarChart, group: "Comercial", module: "comercial" },
  ...
  { title: "Projeção tributária", url: "/contabil/projecao", icon: Calculator, group: "Contábil", module: "contabil" },
  ...
  { title: "Colaboradores", url: "/rh/colaboradores", icon: UsersIcon, group: "Recursos Humanos", module: "rh" },
  { title: "EPIs", url: "/rh/epis", icon: HardHat, group: "Recursos Humanos", module: "rh" },
  { title: "Quadro de Contratação", url: "/rh", icon: UserPlus, group: "Recursos Humanos", module: "rh" },
