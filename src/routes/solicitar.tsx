  ...
  function validarEtapa(): string | null {
    ...
    if (step === 2) {
      ...
      if (form.tipo === "demanda" && !(Number(form.valor_total) > 0))
        return "Informe o valor total da aquisiÃ§Ã£o.";
      return form.descricao.trim().length > 0 ? null : "Descreva a sua aquisiÃ§Ã£o.";
    }
    return null;
  }
    ...
    <Shell>
      ...
      {step === 1 && (
        <Step title="Sobre a solicitação" subtitle="Conte rapidamente do que se trata.">
          <div className="space-y-4">
            ...
            <Field label={isCompra ? "Tipo de compra" : "Tipo de AquisiÃ§Ã£o"}>
                ...
                <label className="flex items-start gap-2 cursor-pointer">
                  ...
                  <span className="text-sm">
                    ...
                    <span className="block text-xs text-muted-foreground">
                      Marque se esta aquisiÃ§Ã£o é um reembolso a alguém da equipe.
                    </span>
                  </span>
                </label>
      ...
      {step === 2 && (
        <Step
          ...
          subtitle={isCompra ? "Liste os itens e quem está solicitando." : "Descreva a aquisiÃ§Ã£o e quem está solicitando."}
        >
          <div className="space-y-5">
            ...
            {usaItens ? (
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  <Label className="text-xs font-medium text-muted-foreground">
                    {isCompra ? "Itens da compra *" : "Itens da aquisiÃ§Ã£o *"}
                  </Label>
                ...
                <Field label="Observações (opcional)">
                  <Textarea
                    ...
                    placeholder={isCompra ? "Algum detalhe adicional sobre a compra…" : "Algum detalhe adicional sobre a aquisiÃ§Ã£o…"}
                  />
                </Field>
              </div>
            ) : (
              <>
                ...
                <Field label="Descreva sua aquisiÃ§Ã£o *">
                  <Textarea
                    rows={6}
                    value={form.descricao}
                    maxLength={4000}
                    onChange={(e) => update({ descricao: e.target.value })}
                    placeholder="Detalhe a aquisiÃ§Ã£o, prazos, locais, observações…"
                  />
                  <p className="text-[11px] text-muted-foreground mt-1">
      ...
      {step === 3 && (
        <Step title="Confira antes de enviar" subtitle="Revise os dados da solicitação.">
          <div className="rounded-lg border border-border divide-y divide-border text-sm">
            <Row k="Tipo" v={isCompra ? "Compra" : "AquisiÃ§Ã£o"} />
